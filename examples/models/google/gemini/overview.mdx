...
| [Db](/examples/models/google/gemini/db) | Run `uv pip install ddgs sqlalchemy google.genai` to install dependencies. |
...
| [Gemini 3 Pro Thinking Level](/examples/models/google/gemini/gemini-3-pro-thinking-level) | Async example using Gemini with tool calls. |
...
| [Tool Use](/examples/models/google/gemini/tool-use) | Run `pip install ddgs` to install dependencies. |
| [Url Context](/examples/models/google/gemini/url-context) | Run `uv pip install google-generativeai` to install dependencies. |
