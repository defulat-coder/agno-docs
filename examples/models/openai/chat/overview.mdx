...
| [Db](/examples/models/openai/chat/db) | Run `uv pip install ddgs sqlalchemy openai` to install dependencies. |
...
| [Tool Use](/examples/models/openai/chat/tool-use) | Run `uv pip install ddgs` to install dependencies. |
