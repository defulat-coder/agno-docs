...
| [Db](/examples/models/anthropic/db) | Run `uv pip install ddgs sqlalchemy anthropic` to install dependencies. |
...
| [Tool Use](/examples/models/anthropic/tool-use) | Run `uv pip install ddgs` to install dependencies. |
