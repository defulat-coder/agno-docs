...
| [Image Transcribe Document Agent](/examples/models/mistral/image-transcribe-document-agent) | This agent transcribes an old written document from an image. |
| [Memory](/examples/models/mistral/memory) | Steps: 1. |
| [Mistral Small](/examples/models/mistral/mistral-small) | Run `uv pip install ddgs` to install dependencies. |
...
| [Tool Use](/examples/models/mistral/tool-use) | Run `uv pip install ddgs` to install dependencies. |
