...
| [Db](/examples/models/cohere/db) | Run `uv pip install ddgs sqlalchemy cohere` to install dependencies. |
...
| [Tool Use](/examples/models/cohere/tool-use) | Run `uv pip install ddgs` to install dependencies. |
