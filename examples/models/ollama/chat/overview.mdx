...
| [Db](/examples/models/ollama/chat/db) | Run `uv pip install ddgs sqlalchemy ollama` to install dependencies. |
...
| [Ollama Cloud](/examples/models/ollama/chat/ollama-cloud) | To use Ollama Cloud, you need to set the OLLAMA_API_KEY environment variable. Host is set to https://ollama.com by default. |
...
| [Tool Use](/examples/models/ollama/chat/tool-use) | Run `uv pip install ddgs` to install dependencies. |
