...
| [Db](/examples/models/vllm/db) | Run `uv pip install sqlalchemy` and ensure Postgres is running (`./cookbook/scripts/run_pgvector.sh`). |
...
| [Build a Web Search Agent using xAI](/examples/models/vllm/tool-use) | Create and activate virtual environment. |
