---
title: "Structured output example using OpenRouter with the Responses API."
description: "This demonstrates using Pydantic models for structured output with OpenRouter's Responses API endpoint."
---
```python
