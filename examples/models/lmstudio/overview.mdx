...
| [Db](/examples/models/lmstudio/db) | Run `uv pip install ddgs sqlalchemy` to install dependencies. |
...
| [Tool Use](/examples/models/lmstudio/tool-use) | Run `uv pip install ddgs` to install dependencies. |
