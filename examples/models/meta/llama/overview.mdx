...
| [Db](/examples/models/meta/llama/db) | Run `uv pip install ddgs sqlalchemy llama-api-client` to install dependencies. |
...
| [Tool Use](/examples/models/meta/llama/tool-use) | Run `uv pip install agno llama-api-client yfinance` to install dependencies. |
