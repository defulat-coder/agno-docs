---
title: "This is an example of how to use the FirecrawlTools"
description: "Use FirecrawlTools for web scraping and crawling with an agent."
---
Prerequisites: - Create a Firecrawl account and get an API key - Set the API key as an environment variable: `export FIRECRAWL_API_KEY=<your-api-key>`
