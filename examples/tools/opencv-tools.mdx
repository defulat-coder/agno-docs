---
title: "OpenCV Tools - Computer Vision and Image Processing"
sidebarTitle: "OpenCV Tools"
description: "This example demonstrates how to use OpenCVTools for computer vision tasks."
---
This example demonstrates how to use OpenCVTools for computer vision tasks. Shows enable_ flag patterns for selective function access. OpenCVTools is a small tool (&lt;6 functions) so it uses enable_ flags.
