---
title: "Example showing stop_after_tool_call_tools with dual inheritance."
sidebarTitle: "Stop After Tool Call Dual Inheritance"
description: "This demonstrates that stop_after_tool_call_tools works correctly even when the Toolkit class uses multiple inheritance."
---
```python
"""
