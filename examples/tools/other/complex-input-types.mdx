---
title: "This example shows how to use complex input types with tools."
sidebarTitle: "Complex Input Types"
description: "Recommendations: - Specify fields with descriptions, these will be used in the JSON schema sent to the model and will increase accuracy."
---
