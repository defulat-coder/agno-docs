...
sidebarTitle: "Nano Banana Tools"
description: "Usage."
---
Usage: - Set your Google API key as environment variable: `export GOOGLE_API_KEY="your_api_key"` - Run `uv pip install agno google-genai Pillow` to install dependencies
