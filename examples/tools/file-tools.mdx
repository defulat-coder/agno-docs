...
description: "This example demonstrates how to use FileTools for file operations."
---
This example demonstrates how to use FileTools for file operations. Shows enable_ flag patterns for selective function access. FileTools is a small tool (&lt;6 functions) so it uses enable_ flags.
