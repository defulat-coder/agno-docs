---
title: "Telegram Tools - Bot Communication and Messaging"
sidebarTitle: "Telegram Tools"
description: "This example demonstrates how to use TelegramTools for Telegram bot operations."
---
This example demonstrates how to use TelegramTools for Telegram bot operations. Shows enable_ flag patterns for selective function access. TelegramTools is a small tool (&lt;6 functions) so it uses enable_ flags.
