---
title: "AWS Lambda Tools - Serverless Function Management"
sidebarTitle: "AWS Lambda Tools"
description: "This example demonstrates how to use AWSLambdaTools for AWS Lambda operations."
---
This example demonstrates how to use AWSLambdaTools for AWS Lambda operations. Shows enable_ flag patterns for selective function access. AWSLambdaTools is a small tool (&lt;6 functions) so it uses enable_ flags.
