---
title: "Airflow Tools - DAG Management and Workflow Automation"
sidebarTitle: "Airflow Tools"
description: "This example demonstrates how to use AirflowTools for managing Apache Airflow DAGs."
---
This example demonstrates how to use AirflowTools for managing Apache Airflow DAGs. Shows enable_ flag patterns for selective function access. AirflowTools is a small tool (&lt;6 functions) so it uses enable_ flags.
