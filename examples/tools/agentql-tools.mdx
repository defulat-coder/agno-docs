---
title: "AgentQL Tools for scraping websites."
description: "Prerequisites: - Set the environment variable `AGENTQL_API_KEY` with your AgentQL API key."
---
Prerequisites: - Set the environment variable `AGENTQL_API_KEY` with your AgentQL API key. You can obtain the API key from the AgentQL website: https://agentql.com/ - Run `playwright install` to install a browser extension for playwright.
