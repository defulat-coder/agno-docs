...
sidebarTitle: "Crawl4AI Tools"
description: "This example demonstrates how to use Crawl4aiTools for web crawling and content extraction."
---
This example demonstrates how to use Crawl4aiTools for web crawling and content extraction. Shows enable_ flag patterns for selective function access. Crawl4aiTools is a small tool (&lt;6 functions) so it uses enable_ flags.
