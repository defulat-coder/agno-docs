---
title: "You can use the Brandfetch API to retrieve the company's brand information."
description: "Register an account at: https://developers.brandfetch.com/register."
---
