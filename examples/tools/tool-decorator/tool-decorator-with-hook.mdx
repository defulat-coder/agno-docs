---
title: "Show how to decorate a custom hook with a tool execution hook."
sidebarTitle: "Tool Decorator With Hook"
description: "Add execution hooks to tools using the decorator pattern."
---
```python
