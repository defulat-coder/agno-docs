---
title: "Example script demonstrating the use of Neo4jTools with an Agno agent."
description: "This script sets up an agent that can interact with a Neo4j database using natural language queries,."
---
