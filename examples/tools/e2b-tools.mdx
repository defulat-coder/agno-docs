---
title: "E2b Tools"
sidebarTitle: "E2B Tools Example"
description: "This example shows how to: 1."
---
This example shows how to: 1. Set up authentication with E2B API 2. Initialize the E2BTools with proper configuration 3. Create an agent that can run Python code in a secure sandbox 4. Use the sandbox for data analysis, visualization, and more
