...
sidebarTitle: "MCP Filesystem Agent"
description: "This example shows how to create a filesystem agent that uses MCP to explore, analyze, and provide insights about files and directories."
---
