---
title: "Stripe MCP Agent - Manage Your Stripe Operations"
sidebarTitle: "Stripe MCP Agent"
description: "This example demonstrates how to create an Agno agent that interacts with the Stripe API via the Model Context Protocol (MCP)."
---
