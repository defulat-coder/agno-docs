---
title: "Supabase MCP Agent - Showcase Supabase MCP Capabilities"
sidebarTitle: "Supabase MCP Agent"
description: "This example demonstrates how to use the Supabase MCP server to create create projects, database schemas, edge functions, and more."
---
