---
title: "MCP Parallel Agent - Search for Parallel"
sidebarTitle: "MCP Parallel Agent"
description: "This example shows how to create an agent that uses Parallel to search for information using the Parallel MCP server."
---
```python
