...
sidebarTitle: "MCP Brave Agent"
description: "This example shows how to create an agent that uses Anthropic to search for information using the Brave MCP server."
---
```python
