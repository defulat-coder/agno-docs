---
title: "Mcp Multiple Servers Allow Partial Failure"
sidebarTitle: "Multiple Servers Allow Partial Failure"
description: "This is useful if you are connecting to MCP servers that are not always available or prone to failure,."
---
