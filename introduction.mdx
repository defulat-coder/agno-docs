...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="user-astronaut" href="/first-agent" iconType="duotone">
    Build and run your first agent.
  </Card>
  <Card title="Explore the SDK" icon="list-tree" href="/agents/overview" iconType="duotone">
    Build agents, teams, workflows.
  </Card>
  <Card title="Learn about AgentOS" icon="server" href="/agent-os/introduction" iconType="duotone">
    Run multi-agent systems as a service.
  </Card>
  <Card title="Deploy AgentOS to your cloud" icon="cloud" href="/deploy/introduction">
    Deploy to AWS, GCP, and Railway.
  </Card>
</CardGroup>
